...
```
git clone https://github.com/amitvashisttech/docker-kubernetes-ericsson-20-June-2022.git
``` 

## Now provision three virtual machines with following commands:

```
cd docker-kubernetes-ericsson-20-June-2022/02-K8s/00-Setup
vagrant.exe up
...
sudo su - 
git clone https://github.com/amitvashisttech/docker-kubernetes-ericsson-20-June-2022.git
cd docker-kubernetes-ericsson-20-June-2022/02-Kubernetes/00-Setup
